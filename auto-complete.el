...
(defvar ac-completing-map
  (let ((map (make-sparse-keymap)))
	...
	;; ab: seem to be missing ac-complete-1
    ;; (dotimes (i 9)
...
(defun ac-candidates-1 (source)
  (let* ((do-cache (assq 'cache source))
	...
	;; ab: this removes ones that don't match prefix. I put some 'info' candidates in that were stripped by this (and this is second guessing the candidate gen function)
